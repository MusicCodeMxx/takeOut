...
/**
 * 自定义异常 - 继承运行异常 - 业务异常封装类 - 针对 401 HTTP 响应处理
 * <li>　401 (Unauthorized/未授权) </li>
 * <p>继承关系 UnauthorizedException => BussinessException => RuntimeException => ...</p>
 * @author: starshine
 * @version: 1.0
 * @since: 2022/7/5  下午 12:31  周二
 * @Description:
 */
public class UnauthorizedException extends BussinessException{
     ...
     */
    public UnauthorizedException(R r) {
        super(r);
    }
