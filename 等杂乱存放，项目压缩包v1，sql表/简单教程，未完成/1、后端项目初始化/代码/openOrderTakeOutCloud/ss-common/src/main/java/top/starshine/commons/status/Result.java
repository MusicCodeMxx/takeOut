...
public class Result<T> implements java.io.Serializable {
    ...
    //public static <K> Result<K> success(K data){ return new Result<K>(data);}
     ...
     * 检查响应状态是否成功
     * <ul>
     *     <li>若响应状态为假(false),这里就取反最后返回真(true)</li>
     *     <li>如果响应状态为真(true),这里就取反最后返回假(false)</li>
     * </ul>
     * @return {@link boolean} 响应状态
     */
    public boolean isStatusNotTure(){
        return !status;
    }
